    ...
    $("#content").append(
        $(`
            <div class="aboutContainer">
                ...
                <p>
                    Auteur: Nicolas Chourot et Colin Bougie
                </p>
                <p>
...
async function renderBookmarks() {
    ...
    if (bookmarks !== null) {
        ...
        $(".bookmarkLayout").on("click", function () {
            window.open($(this).attr("href"), '_blank');
        });
        $(".bookmarkRow").on("click", function (e) { e.preventDefault(); })
        updateDropDownMenu(bookmarks.map((bookmark) => bookmark.Category));
    } else {
...
async function renderDeleteBookmarkForm(id) {
    ...
    eraseContent();
    if (bookmark !== null) {
        let logoUrl = `https://www.google.com/s2/favicons?sz=64&domain_url=${bookmark.Url}`;
        $("#content").append(`
        <div class="bookmarkDeleteForm">
            ...
            <div class="bookmarkRow" bookmark_id=${bookmark.Id}">
                <div class="bookmarkContainer">
                    <div class="bookmarkLayout" href="${bookmark.Url}">
                        <div class="bookmarkTitle"><img src="${logoUrl}" class="bookmarkLogo"> ${bookmark.Title}</div>
